...
<script type="text/javascript" src="../../js/myjs/alarminfo.js"></script>
...
<body onload="init()">
	...
	<table  id="dg" class = "easyui-datagrid" style = "width:880px;height:435px;" url="http://172.16.10.165:8080/sss/servlet/AlarminfoList?mudi=0"  ></table>
